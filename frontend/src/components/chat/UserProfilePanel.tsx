...
export const UserProfilePanel: React.FC = () => {
  ...
  useEffect(() => {
    if (!profilePanelUser) { setProfile(null); return; }
  ...
  return (
    <>
    <div className="w-[280px] shrink-0 border-l border-slate-100 bg-white flex flex-col overflow-hidden">
      {/* Header */}
          ...
          <>
            ...
            <div className="mx-4 mb-3 p-3 bg-slate-50 rounded-2xl">
              <div className="flex items-start gap-2">
                ...
                <p className={`text-[13px] leading-relaxed ${profile?.bio ? "text-slate-600" : "text-slate-400 italic"}`}>
